        ...
        execute: function() {
            DemoQuestionnaireComponent = (function () {
                function DemoQuestionnaireComponent(demoQ) {
                    ...
                    this.timeSinceExtendedViewClose = 100;
                    this.questionName = "Null";
                    this.questionsSubmitted = 2;
                    this.adverseEvents = 0;
                    this.status = true;
                }
                ...
                DemoQuestionnaireComponent.prototype.showExtendedView = function () {
                    var timeT = Date.now() - 100;
                    if (this.timeSinceExtendedViewClose < timeT)
                        this.isExtendedView = true;
                };
                DemoQuestionnaireComponent.prototype.closeExtendedView = function () {
                    this.isExtendedView = false;
